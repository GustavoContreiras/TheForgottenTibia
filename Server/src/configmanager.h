...
class ConfigManager
{
	public:
		...
		enum integer_config_t {
			...
			CRITICAL_ON_ALL_WEAPONS_AMOUNT,
			CRITICAL_ON_ALL_WEAPONS_CHANCE,
			CRITICAL_ON_ALL_WEAPONS_DUAL_WIELDING_CHANCE,
			CRITICAL_ON_ALL_WEAPONS_DUAL_WIELDING_AMOUNT,
			CRITICAL_ON_WANDS_AND_RODS_CHANCE,
			CRITICAL_ON_WANDS_AND_RODS_AMOUNT,
			CRITICAL_ON_TWO_HANDED_DIST_WEAPONS_AMOUNT,
			CRITICAL_ON_TWO_HANDED_DIST_WEAPONS_CHANCE,
			CRITICAL_ON_ONE_HANDED_DIST_WEAPONS_AMOUNT,
			CRITICAL_ON_ONE_HANDED_DIST_WEAPONS_CHANCE,
			SQL_PORT,
			MAX_PLAYERS,
			PZ_LOCKED,
