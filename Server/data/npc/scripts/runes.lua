...
shopModule:addBuyableItem({'small health potion'}, 8704, 20, 1, 'small health potion')
...
shopModule:addBuyableItem({'ultimate health potion'}, 8473, 310, 1, 'ultimate health potion')
...
shopModule:addBuyableItem({'chameleon'},         	2291, 210, 1, 'chameleon rune')
shopModule:addBuyableItem({'convince creature'},    2290, 80, 1, 'convince creature rune')
shopModule:addBuyableItem({'disintegrate'},         2310, 26, 1, 'disintegrate rune')
...
shopModule:addBuyableItem({'wand of vortex', 'vortex'}, 2190, 375, 'wand of vortex')
shopModule:addBuyableItem({'wand of dragonbreath', 'dragonbreath'}, 2191, 750, 'wand of dragonbreath')
shopModule:addBuyableItem({'wand of decay', 'decay'}, 2188, 3750, 'wand of decay')
shopModule:addBuyableItem({'wand of draconia', 'draconia'}, 8921, 5625, 'wand of draconia')
shopModule:addBuyableItem({'wand of cosmic energy', 'cosmic energy'}, 2189, 7500, 'wand of cosmic energy')
shopModule:addBuyableItem({'wand of inferno', 'inferno'}, 2187, 9750, 'wand of inferno')
shopModule:addBuyableItem({'wand of starstorm', 'starstorm'}, 8920, 13500, 'wand of starstorm')
shopModule:addBuyableItem({'wand of voodoo', 'voodoo'}, 8922, 16500, 'wand of voodoo')

shopModule:addBuyableItem({'snakebite rod', 'snakebite'}, 2182, 375, 'snakebite rod')
shopModule:addBuyableItem({'moonlight rod', 'moonlight'}, 2186, 750, 'moonlight rod')
shopModule:addBuyableItem({'necrotic rod', 'necrotic'}, 2185, 3750, 'necrotic rod')
shopModule:addBuyableItem({'northwind rod', 'northwind'}, 8911, 5625, 'northwind rod')
shopModule:addBuyableItem({'terra rod', 'terra'}, 2181, 7500, 'terra rod')
shopModule:addBuyableItem({'hailstorm rod', 'hailstorm'}, 2183, 9750, 'hailstorm rod')
shopModule:addBuyableItem({'springsprout rod', 'springsprout'}, 8912, 13500, 'springsprout rod')
shopModule:addBuyableItem({'underworld rod', 'underworld'}, 8910, 16500, 'underworld rod')
