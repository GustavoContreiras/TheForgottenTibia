...
local voices = { {text = 'Don\'t forget to deposit your money here in the The Forgotten Bank before you head out for adventure.'} }
if VoiceModule then
...
---------------------------- HELP ------------------------
    if msgcontains(msg, 'bank account') then
        npcHandler:say({
            ...
            'Would you like to know more about the {basic} functions of your bank account or are you already bored, perhaps?'
        }, cid)
...
keywordHandler:addKeyword({'help'}, StdModule.say, {npcHandler = npcHandler, text = 'You can check the {balance} of your bank account, {deposit} money or {withdraw} it. You can also {transfer} money to other characters.'})
keywordHandler:addKeyword({'functions'}, StdModule.say, {npcHandler = npcHandler, text = 'You can check the {balance} of your bank account, {deposit} money or {withdraw} it. You can also {transfer} money to other characters.'})
keywordHandler:addKeyword({'basic'}, StdModule.say, {npcHandler = npcHandler, text = 'You can check the {balance} of your bank account, {deposit} money or {withdraw} it. You can also {transfer} money to other characters and pay the rent of your house or itens on the market.'})
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = 'I work in this bank. I can help you with your {bank account}.'})
 
npcHandler:setMessage(MESSAGE_GREET, "Yes? What may I do for you, |PLAYERNAME|? Check out your {bank account}, perhaps?")
