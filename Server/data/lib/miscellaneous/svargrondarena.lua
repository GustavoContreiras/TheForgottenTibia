...
SvargrondArena = {
	...
	kickTime = 600,
	kickPosition = Position(33058, 31318, 7),
	rewardPosition = Position(33053, 31289, 10),
...
local firstPit = {
	fromPos = {x = centerX-5, y = centerY-4, z = centerZ},
	toPos = {x = centerX+4, y = centerY+5, z = centerZ},
	center = {x = centerX, y = centerY, z = centerZ},
	pillar = {x = centerX-6, y = centerY, z = centerZ},
	tp = {x = centerX-6, y = centerY, z = centerZ},
	summon = {x = centerX, y = centerY+2, z = centerZ}
}
...
ARENA = {
	[1] = {
		name = 'Greenhorn',
		price = 1000,
		questLog = SvargrondArena.Storages.QuestLogGreenhorn,
		...
		reward = {
			trophy = 5807,
			trophyStorage = SvargrondArena.Storages.TrophyGreenhorn,
	...
	[2] = {
		name = 'Scrapper',
		price = 5000,
		questLog = SvargrondArena.Storages.QuestLogScrapper,
		...
		reward = {
			trophy = 5806,
			trophyStorage = SvargrondArena.Storages.TrophyScrapper,
	...
	[3] = {
		name = 'Warlord',
		price = 10000,
		questLog = SvargrondArena.Storages.QuestLogWarlord,
		...
		reward = {
			trophy = 5805,
			trophyStorage = SvargrondArena.Storages.TrophyWarlord,
