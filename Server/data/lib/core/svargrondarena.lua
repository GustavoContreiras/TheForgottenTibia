...
SvargrondArena = {
	...
	kickTime = 600,
	kickPosition = Position(32776, 31040, 6),
	rewardPosition = Position(32747, 31023, 6),
...
local firstPit = {
	fromPos = {x = 32730, y = 31037, z = 7},
	toPos = {x = 32739, y = 31046, z = 7},
	center = {x = 32734, y = 31041, z = 7},
	pillar = {x = 32729, y = 31041, z = 7},
	tp = {x = 32729, y = 31041, z = 7},
	summon = {x = 32734, y = 31043, z = 7}
}
