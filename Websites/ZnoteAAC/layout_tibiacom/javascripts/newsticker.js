...
function OpenNews(id)
{
  ...
  document.getElementById(idButton).style.backgroundImage = "url('" + IMAGES + "/global/general/minus.gif')";
}
...
function CloseNews(id)
{
  ...
  document.getElementById(idButton).style.backgroundImage = "url('" + IMAGES + "/global/general/plus.gif')";
}
