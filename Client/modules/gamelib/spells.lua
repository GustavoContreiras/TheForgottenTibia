...
SpellInfo = {
  ['Default'] = {
    ...
    ['Ethereal Spear'] =           {id = 111, words = 'exori con',             exhaustion = 2000, premium = false, type = 'Instant', icon = 'etherealspear',          strenght = 8, dexterity = 70, intelligence = 8,     faith = 8,     mana = 25,     level = 23, soul = 0, group = {[1] = 2000},              vocations = {3, 7}},
    ['Strong Ethereal Spear'] =    {id = 57,  words = 'exori gran con',        exhaustion = 2000, premium = false, type = 'Instant', icon = 'strongetherealspear',    strenght = 8, dexterity = 100, intelligence = 8,     faith = 8,     mana = 55,     level = 90, soul = 0, group = {[1] = 2000},               vocations = {3, 7}},
    ...
    ['Ignite'] =                   {id = 138, words = 'utori flam',            exhaustion = 2000, premium = false, type = 'Instant', icon = 'ignite',                 strenght = 8, dexterity = 8, intelligence = 26,     faith = 8,     mana = 30,     level = 26, soul = 0, group = {[1] = 2000},               vocations = {1, 5}},
    ['Lightning'] =                {id = 149, words = 'exori amp vis',         exhaustion = 2000, premium = false, type = 'Instant', icon = 'lightning',              strenght = 8, dexterity = 8, intelligence = 55,     faith = 8,     mana = 60,     level = 55, soul = 0, group = {[1] = 2000, [4] = 2000},   vocations = {1, 5}},
    ...
    ['Hells Core'] =               {id = 24,  words = 'exevo gran mas flam',   exhaustion = 2000, premium = false, type = 'Instant', icon = 'hellscore',              strenght = 8, dexterity = 8, intelligence = 60,     faith = 8,     mana = 1100,   level = 60, soul = 0, group = {[1] = 2000},               vocations = {1, 5}},
    ...
    ['Divine Caldera'] =           {id = 124, words = 'exevo mas san',         exhaustion = 2000, premium = false, type = 'Instant', icon = 'divinecaldera',          strenght = 8, dexterity = 8, intelligence = 8,     faith = 42,     mana = 160,    level = 50, soul = 0, group = {[1] = 2000},               vocations = {3, 7}},
    ...
    ['Protect Party'] =            {id = 127, words = 'utamo mas sio',         exhaustion = 2000, premium = false, type = 'Instant', icon = 'protectparty',           strenght = 8, dexterity = 8, intelligence = 8,     faith = 8,     mana = 'Var.', level = 32, soul = 0, group = {[3] = 2000},               vocations = {7}},
    ['Heal Party'] =               {id = 128, words = 'utura mas sio',         exhaustion = 2000, premium = false, type = 'Instant', icon = 'healparty',              strenght = 8, dexterity = 8, intelligence = 8,     faith = 50,     mana = 'Var.', level = 32, soul = 0, group = {[3] = 2000},               vocations = {6}},
    ['Enchant Party'] =            {id = 129, words = 'utori mas sio',         exhaustion = 2000, premium = false, type = 'Instant', icon = 'enchantparty',           strenght = 8, dexterity = 8, intelligence = 8,     faith = 8,     mana = 'Var.', level = 32, soul = 0, group = {[3] = 2000},               vocations = {5}},
    ...
    ['Food'] =                     {id = 42,  words = 'exevo pan',             exhaustion = 2000, premium = false, type = 'Instant', icon = 'food',                   strenght = 8, dexterity = 8, intelligence = 8,     faith = 14,    mana = 120,    level = 14, soul = 1, group = {[3] = 2000},               vocations = {2, 6}},
