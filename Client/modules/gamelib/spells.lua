...
SpellInfo = {
  ['Default'] = {
	...
	['Strong Ethereal Spear'] =    {id = 57,  words = 'exori gran con',        exhaustion = 2000, premium = false, type = 'Instant', icon = 'strongetherealspear',    strenght = 8, dexterity = 100, intelligence = 14,  faith = 8,     mana = 55,     level = 90, soul = 0, group = {[1] = 2000},               vocations = {3, 7}},    
