...
SpellInfo = {
  ['Default'] = {
    ...
    ['Divine Caldera'] =           {id = 124, words = 'exevo mas san',         exhaustion = 2000, premium = false, type = 'Instant', icon = 'divinecaldera',          strenght = 8, dexterity = 8, intelligence = 8,     faith = 42,    mana = 480,    level = 50, soul = 0, group = {[1] = 2000},               vocations = {3, 7}},
